...
import 'package:scroll_kit/src/refresh/internals/indicator_wrap.dart';
import 'package:scroll_kit/src/refresh/smart_refresher.dart';
...
class _BezierCircleHeaderState extends State<BezierCircleHeader>
  ...
  Widget build(BuildContext context) {
    ...
    return BezierHeader(
      ...
      onModeChange: (dynamic m) {
        mode = m as RefreshStatus;
